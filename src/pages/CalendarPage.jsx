...
function CalendarPage() {
  ...
  const [appointments, setAppointments] = useState({
    '2024-11-14': [
      { time: '10 AM', doctor: 'Doctor A', hospital: 'Hospital B', status: 'pending' },
      { time: '10 AM', doctor: 'Doctor A', hospital: 'Hospital B', status: 'rejected' },
      { time: '2 PM', doctor: 'Doctor A', hospital: 'Hospital B', status: 'accepted' },
    ],
    '2024-11-16': [
      { time: '3 PM', doctor: 'Doctor A', hospital: 'Hospital B', status: 'accepted' },
    ],
  ...
  return (
    <div className="flex flex-col md:flex-row w-full justify-center items-center gap-10 p-5">
      <Calender
